...
SUPABASE_URL = "https://mhmpjukowcgxlaqxmehl.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1obXBqdWtvd2NneGxhcXhtZWhsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTA3MTkxOCwiZXhwIjoyMDg0NjQ3OTE4fQ.aZSO75dH1AM72x5YFZ1zTMk7Y7QGVpMtSY2hT1vpS-U" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES1UG23CS720.png"  # Replace with the local image path
image_name = "PES1UG23CS720.png"  # Desired name for the uploaded file
